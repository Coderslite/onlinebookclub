...
<!-- Mirrored from demo.foxthemes.net/courseplus-v4.3.1/default/form-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Sep 2022 09:31:24 GMT -->
<head>
  <meta charset="UTF-8">
  ...
  <div id="wrapper" class="flex flex-col justify-between h-screen">
      ...
      <div>
        ...
        <div class="lg:p-12 max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
            ...
            <form method="POST" action="php/login.php" class="lg:p-10 p-6 space-y-3 relative bg-white shadow-xl rounded-md">
...
<!-- Mirrored from demo.foxthemes.net/courseplus-v4.3.1/default/form-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Sep 2022 09:31:25 GMT -->
</html>